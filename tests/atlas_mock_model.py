...
ARCHES = {
    ...
    "bonsai_1_7b": dict(
        n_layers=2, hidden=2048, inter=6144,
        n_heads=16, n_kv_heads=8, head_dim=128,
        vocab=151669, rope_theta=1000000.0,
        rope_interleaved=True, stride=11,
        arch="qwen3",
        layer_tensors=[
            "input_layernorm.weight",
    ...
    "bonsai_4b": dict(
        n_layers=2, hidden=2560, inter=9728,
        n_heads=32, n_kv_heads=8, head_dim=128,
        vocab=151669, rope_theta=5000000.0,
        rope_interleaved=True, stride=11,
        arch="qwen3",
        layer_tensors=[
            "input_layernorm.weight",
    ...
    "bonsai_8b": dict(
        n_layers=2, hidden=4096, inter=12288,
        n_heads=32, n_kv_heads=8, head_dim=128,
        vocab=151669, rope_theta=1000000.0,
        rope_interleaved=True, stride=11,
        arch="qwen3",
    ...
    "bitcpm": dict(
        ...
        vocab=73448, rope_theta=10000.0,
        rope_interleaved=False, stride=9,
        arch="llama",
        layer_tensors=[
            "input_layernorm.weight",
    ...
    "trilm_1_5b": dict(
        ...
        vocab=50432, rope_theta=10000.0,
        rope_interleaved=False, stride=11,
        arch="trilm",
        layer_tensors=[
            "input_layernorm.weight",
    ...
    "trilm_2_4b": dict(
        n_layers=2, hidden=2304, inter=7680,
    ...
    "trilm_3_9b": dict(
        n_layers=2, hidden=3072, inter=9216,
        n_heads=24, n_kv_heads=24, head_dim=128,
        vocab=50688, rope_theta=10000.0,
        rope_interleaved=False, stride=9,
        arch="llama",
        layer_tensors=[
            "input_layernorm.weight",
